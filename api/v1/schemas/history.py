...
class HistoryItem(BaseModel):
    ...
    report_language: Optional[str] = Field(None, description="Report output language")
    is_legacy: Optional[bool] = Field(None, description="Whether the record uses an older report format")
